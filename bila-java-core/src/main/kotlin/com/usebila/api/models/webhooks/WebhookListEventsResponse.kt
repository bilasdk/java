...
private constructor(
     ...
     */
    fun data(): Optional<List<String>> = data.getOptional("data")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListEventsResponse: WebhookListEventsResponse) = apply {
            ...
            data = webhookListEventsResponse.data.map { it.toMutableList() }
    ...
    override fun toString() =
        "WebhookListEventsResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
