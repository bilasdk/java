...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectionRetrieveResponse].
         *
    ...
    /** A builder for [CollectionRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectionRetrieveResponse: CollectionRetrieveResponse) = apply {
            message = collectionRetrieveResponse.message
            status = collectionRetrieveResponse.status
            data = collectionRetrieveResponse.data
            additionalProperties = collectionRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionRetrieveResponse].
         *
         ...
         */
        fun build(): CollectionRetrieveResponse =
     ...
     *   type.
     */
    fun validate(): CollectionRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionRetrieveResponse &&
    ...
    override fun toString() =
        "CollectionRetrieveResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
