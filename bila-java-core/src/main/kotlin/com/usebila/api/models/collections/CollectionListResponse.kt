...
private constructor(
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val data: JsonField<List<BilaCollectionResponseDto>>,
        ...
        private constructor(
            @JsonProperty("data")
            @ExcludeMissing
            data: JsonField<List<BilaCollectionResponseDto>> = JsonMissing.of(),
            @JsonProperty("meta")
            @ExcludeMissing
         ...
         */
        fun data(): List<BilaCollectionResponseDto> = data.getRequired("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<BilaCollectionResponseDto>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<BilaCollectionResponseDto>>? = null
            ...
            /** List of collections */
            fun data(data: List<BilaCollectionResponseDto>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed
             * `List<BilaCollectionResponseDto>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
            fun data(data: JsonField<List<BilaCollectionResponseDto>>) = apply {
                this.data = data.map { it.toMutableList() }
            }

            /**
             * Adds a single [BilaCollectionResponseDto] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: BilaCollectionResponseDto) = apply {
                this.data =
