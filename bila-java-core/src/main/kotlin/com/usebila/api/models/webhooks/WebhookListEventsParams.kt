...
private constructor(
    ...
    /** A builder for [WebhookListEventsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookListEventsParams: WebhookListEventsParams) = apply {
        ...
        fun build(): WebhookListEventsParams =
            WebhookListEventsParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookListEventsParams &&
    ...
    override fun toString() =
        "WebhookListEventsParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
