...
class TransferRecipientRetrieveResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val message: JsonField<String>,
    private val status: JsonField<Boolean>,
    private val data: JsonField<RecipientResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<RecipientResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<RecipientResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<RecipientResponseDto> = data
    ...
    /** A builder for [TransferRecipientRetrieveResponse]. */
    class Builder internal constructor() {

        private var message: JsonField<String>? = null
        private var status: JsonField<Boolean>? = null
        private var data: JsonField<RecipientResponseDto> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(transferRecipientRetrieveResponse: TransferRecipientRetrieveResponse) =
            apply {
                ...
                additionalProperties =
                    transferRecipientRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        fun data(data: RecipientResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [RecipientResponseDto] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<RecipientResponseDto>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientRetrieveResponse].
         *
         ...
         */
        fun build(): TransferRecipientRetrieveResponse =
            TransferRecipientRetrieveResponse(
     ...
     *   type.
     */
    fun validate(): TransferRecipientRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientRetrieveResponse &&
    ...
    override fun toString() =
        "TransferRecipientRetrieveResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
