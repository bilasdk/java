...
private constructor(
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val data: JsonField<List<TransactionResponseDto>>,
        ...
        private constructor(
            @JsonProperty("data")
            @ExcludeMissing
            data: JsonField<List<TransactionResponseDto>> = JsonMissing.of(),
            @JsonProperty("meta")
            @ExcludeMissing
         ...
         */
        fun data(): List<TransactionResponseDto> = data.getRequired("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<TransactionResponseDto>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<TransactionResponseDto>>? = null
            ...
            /** List of transactions */
            fun data(data: List<TransactionResponseDto>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed
             * `List<TransactionResponseDto>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
            fun data(data: JsonField<List<TransactionResponseDto>>) = apply {
                this.data = data.map { it.toMutableList() }
            }

            /**
             * Adds a single [TransactionResponseDto] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: TransactionResponseDto) = apply {
                this.data =
