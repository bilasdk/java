...
private constructor(
    ...
    private val data: JsonField<List<WebhookConfigResponseDto>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<WebhookConfigResponseDto>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<WebhookConfigResponseDto>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<WebhookConfigResponseDto>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<WebhookConfigResponseDto>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(webhookListResponse: WebhookListResponse) = apply {
            message = webhookListResponse.message
        ...
        fun data(data: List<WebhookConfigResponseDto>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<WebhookConfigResponseDto>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<WebhookConfigResponseDto>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [WebhookConfigResponseDto] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: WebhookConfigResponseDto) = apply {
            this.data =
    ...
    override fun toString() =
        "WebhookListResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
