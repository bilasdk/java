...
class TransferInitiateBankTransferResponse
...
private constructor(
    ...
    /** A builder for [TransferInitiateBankTransferResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                transferInitiateBankTransferResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferInitiateBankTransferResponse].
         *
         ...
         */
        fun build(): TransferInitiateBankTransferResponse =
            TransferInitiateBankTransferResponse(
     ...
     *   type.
     */
    fun validate(): TransferInitiateBankTransferResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferInitiateBankTransferResponse &&
    ...
    override fun toString() =
        "TransferInitiateBankTransferResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
