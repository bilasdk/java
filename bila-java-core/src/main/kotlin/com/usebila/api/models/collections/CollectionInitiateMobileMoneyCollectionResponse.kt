...
class CollectionInitiateMobileMoneyCollectionResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val message: JsonField<String>,
    private val status: JsonField<Boolean>,
    private val data: JsonField<BilaCollectionResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<BilaCollectionResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<BilaCollectionResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<BilaCollectionResponseDto> = data
    ...
    /** A builder for [CollectionInitiateMobileMoneyCollectionResponse]. */
    class Builder internal constructor() {

        private var message: JsonField<String>? = null
        private var status: JsonField<Boolean>? = null
        private var data: JsonField<BilaCollectionResponseDto> = JsonMissing.of()
        ...
        internal fun from(
            ...
            additionalProperties =
                collectionInitiateMobileMoneyCollectionResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: BilaCollectionResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [BilaCollectionResponseDto]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<BilaCollectionResponseDto>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [CollectionInitiateMobileMoneyCollectionResponse].
         *
         ...
         */
        fun build(): CollectionInitiateMobileMoneyCollectionResponse =
            CollectionInitiateMobileMoneyCollectionResponse(
     ...
     *   type.
     */
    fun validate(): CollectionInitiateMobileMoneyCollectionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionInitiateMobileMoneyCollectionResponse &&
    ...
    override fun toString() =
        "CollectionInitiateMobileMoneyCollectionResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
