...
class TransferInitiateMobileMoneyTransferResponse
...
private constructor(
    ...
    /** A builder for [TransferInitiateMobileMoneyTransferResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                transferInitiateMobileMoneyTransferResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferInitiateMobileMoneyTransferResponse].
         *
         ...
         */
        fun build(): TransferInitiateMobileMoneyTransferResponse =
            TransferInitiateMobileMoneyTransferResponse(
     ...
     *   type.
     */
    fun validate(): TransferInitiateMobileMoneyTransferResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferInitiateMobileMoneyTransferResponse &&
    ...
    override fun toString() =
        "TransferInitiateMobileMoneyTransferResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
