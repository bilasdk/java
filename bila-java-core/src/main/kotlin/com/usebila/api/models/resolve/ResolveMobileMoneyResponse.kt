...
class ResolveMobileMoneyResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val message: JsonField<String>,
    private val status: JsonField<Boolean>,
    private val data: JsonField<ResolvedAccountResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<ResolvedAccountResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<ResolvedAccountResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ResolvedAccountResponseDto> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResolveMobileMoneyResponse].
         *
    ...
    /** A builder for [ResolveMobileMoneyResponse]. */
    class Builder internal constructor() {

        private var message: JsonField<String>? = null
        private var status: JsonField<Boolean>? = null
        private var data: JsonField<ResolvedAccountResponseDto> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(resolveMobileMoneyResponse: ResolveMobileMoneyResponse) = apply {
            message = resolveMobileMoneyResponse.message
            status = resolveMobileMoneyResponse.status
            data = resolveMobileMoneyResponse.data
            additionalProperties = resolveMobileMoneyResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: ResolvedAccountResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ResolvedAccountResponseDto]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<ResolvedAccountResponseDto>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ResolveMobileMoneyResponse].
         *
         ...
         */
        fun build(): ResolveMobileMoneyResponse =
     ...
     *   type.
     */
    fun validate(): ResolveMobileMoneyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResolveMobileMoneyResponse &&
    ...
    override fun toString() =
        "ResolveMobileMoneyResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
