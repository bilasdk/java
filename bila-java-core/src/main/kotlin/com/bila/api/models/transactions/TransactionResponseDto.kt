...
private constructor(
    ...
    private val balanceAfter: JsonField<Double>,
    private val balanceBefore: JsonField<Double>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        balanceAfter: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("balanceBefore")
        @ExcludeMissing
        balanceBefore: JsonField<Double> = JsonMissing.of(),
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun balanceAfter(): Double = balanceAfter.getRequired("balanceAfter")
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun balanceBefore(): Double = balanceBefore.getRequired("balanceBefore")
    ...
    @JsonProperty("balanceAfter")
    @ExcludeMissing
    fun _balanceAfter(): JsonField<Double> = balanceAfter
    ...
    @JsonProperty("balanceBefore")
    @ExcludeMissing
    fun _balanceBefore(): JsonField<Double> = balanceBefore
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionResponseDto].
         *
    ...
    /** A builder for [TransactionResponseDto]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var accountId: JsonField<String>? = null
        private var amount: JsonField<Double>? = null
        private var balanceAfter: JsonField<Double>? = null
        private var balanceBefore: JsonField<Double>? = null
        ...
        @JvmSynthetic
        internal fun from(transactionResponseDto: TransactionResponseDto) = apply {
            id = transactionResponseDto.id
            accountId = transactionResponseDto.accountId
            amount = transactionResponseDto.amount
            balanceAfter = transactionResponseDto.balanceAfter
            balanceBefore = transactionResponseDto.balanceBefore
            ...
            description = transactionResponseDto.description
            reference = transactionResponseDto.reference
            additionalProperties = transactionResponseDto.additionalProperties.toMutableMap()
        }
        ...
        /** Balance after transaction */
        fun balanceAfter(balanceAfter: Double) = balanceAfter(JsonField.of(balanceAfter))

        /**
         * Sets [Builder.balanceAfter] to an arbitrary JSON value.
         *
         * You should usually call [Builder.balanceAfter] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun balanceAfter(balanceAfter: JsonField<Double>) = apply {
            this.balanceAfter = balanceAfter
        }

        /** Balance before transaction */
        fun balanceBefore(balanceBefore: Double) = balanceBefore(JsonField.of(balanceBefore))

        /**
         * Sets [Builder.balanceBefore] to an arbitrary JSON value.
         *
         * You should usually call [Builder.balanceBefore] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun balanceBefore(balanceBefore: JsonField<Double>) = apply {
        ...
        /**
         * Returns an immutable instance of [TransactionResponseDto].
         *
         ...
         */
        fun build(): TransactionResponseDto =
     ...
     *   type.
     */
    fun validate(): TransactionResponseDto = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TransactionResponseDto{id=$id, accountId=$accountId, amount=$amount, balanceAfter=$balanceAfter, balanceBefore=$balanceBefore, createdAt=$createdAt, currency=$currency, status=$status, type=$type, description=$description, reference=$reference, additionalProperties=$additionalProperties}"
}
