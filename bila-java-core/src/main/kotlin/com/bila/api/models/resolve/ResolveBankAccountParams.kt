...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResolveBankAccountParams].
         *
    ...
    /** A builder for [ResolveBankAccountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(resolveBankAccountParams: ResolveBankAccountParams) = apply {
            body = resolveBankAccountParams.body.toBuilder()
            additionalHeaders = resolveBankAccountParams.additionalHeaders.toBuilder()
            additionalQueryParams = resolveBankAccountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ResolveBankAccountParams].
         *
         ...
         */
        fun build(): ResolveBankAccountParams =
    ...
    private constructor(
        ...
        ) : this(accountNumber, bankId, country, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountNumber, bankId, country, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{accountNumber=$accountNumber, bankId=$bankId, country=$country, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResolveBankAccountParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ResolveBankAccountParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
