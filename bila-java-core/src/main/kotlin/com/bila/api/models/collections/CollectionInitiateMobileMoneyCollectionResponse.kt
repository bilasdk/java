...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, amount=$amount, createdAt=$createdAt, currency=$currency, customer=$customer, reference=$reference, status=$status, completedAt=$completedAt, feeBearer=$feeBearer, narration=$narration, additionalProperties=$additionalProperties}"
    }
