...
class TransferRecipientCreateBankAccountResponse
...
private constructor(
    ...
    /** A builder for [TransferRecipientCreateBankAccountResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                transferRecipientCreateBankAccountResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientCreateBankAccountResponse].
         *
         ...
         */
        fun build(): TransferRecipientCreateBankAccountResponse =
            TransferRecipientCreateBankAccountResponse(
     ...
     *   type.
     */
    fun validate(): TransferRecipientCreateBankAccountResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientCreateBankAccountResponse &&
    ...
    override fun toString() =
        "TransferRecipientCreateBankAccountResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
