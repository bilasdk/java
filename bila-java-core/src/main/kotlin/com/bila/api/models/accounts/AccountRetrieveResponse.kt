...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [tillNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tillNumber")
            @ExcludeMissing
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, currency=$currency, details=$details, status=$status, type=$type, availableBalance=$availableBalance, ledgerBalance=$ledgerBalance, additionalProperties=$additionalProperties}"
    }
