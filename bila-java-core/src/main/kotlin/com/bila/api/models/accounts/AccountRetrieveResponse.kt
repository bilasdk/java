...
private constructor(
    ...
    private val data: JsonField<AccountResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<AccountResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<AccountResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<AccountResponseDto> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<AccountResponseDto> = JsonMissing.of()
        ...
        fun data(data: AccountResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [AccountResponseDto] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<AccountResponseDto>) = apply { this.data = data }
    ...
    override fun toString() =
        "AccountRetrieveResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
