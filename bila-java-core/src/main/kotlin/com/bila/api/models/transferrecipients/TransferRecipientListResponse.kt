...
class TransferRecipientListResponse
...
private constructor(
    ...
    /** A builder for [TransferRecipientListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transferRecipientListResponse: TransferRecipientListResponse) = apply {
            ...
            additionalProperties = transferRecipientListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientListResponse].
         *
         ...
         */
        fun build(): TransferRecipientListResponse =
            TransferRecipientListResponse(
     ...
     *   type.
     */
    fun validate(): TransferRecipientListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val data: JsonField<List<RecipientResponseDto>>,
        ...
        private constructor(
            @JsonProperty("data")
            @ExcludeMissing
            data: JsonField<List<RecipientResponseDto>> = JsonMissing.of(),
            @JsonProperty("meta")
            @ExcludeMissing
         ...
         */
        fun data(): List<RecipientResponseDto> = data.getRequired("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<RecipientResponseDto>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<RecipientResponseDto>>? = null
            ...
            /** List of recipients */
            fun data(data: List<RecipientResponseDto>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<RecipientResponseDto>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun data(data: JsonField<List<RecipientResponseDto>>) = apply {
                this.data = data.map { it.toMutableList() }
            }

            /**
             * Adds a single [RecipientResponseDto] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: RecipientResponseDto) = apply {
                this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientListResponse &&
    ...
    override fun toString() =
        "TransferRecipientListResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
