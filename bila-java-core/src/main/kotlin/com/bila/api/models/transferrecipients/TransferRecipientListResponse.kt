    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("bankId")
                @ExcludeMissing
                bankId: JsonField<String> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                ...
                internal fun from(innerData: InnerData) = apply {
                    id = innerData.id
                    accountName = innerData.accountName
                    country = innerData.country
                    createdAt = innerData.createdAt
                    type = innerData.type
                    accountNumber = innerData.accountNumber
                    bankId = innerData.bankId
                    bankName = innerData.bankName
                    operator = innerData.operator
                 ...
                 *
                 * You should usually call [Builder.bankId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            override fun toString() =
                "InnerData{id=$id, accountName=$accountName, country=$country, createdAt=$createdAt, type=$type, accountNumber=$accountNumber, bankId=$bankId, bankName=$bankName, operator=$operator, phone=$phone, additionalProperties=$additionalProperties}"
        }
