...
private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(innerData: InnerData) = apply {
                    id = innerData.id
                    accountId = innerData.accountId
                    amount = innerData.amount
                    balanceAfter = innerData.balanceAfter
                    balanceBefore = innerData.balanceBefore
                 ...
                 *
                 * You should usually call [Builder.balanceAfter] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /** Balance before transaction */
                fun balanceBefore(balanceBefore: Double) =
                    balanceBefore(JsonField.of(balanceBefore))

                /**
                 * Sets [Builder.balanceBefore] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.balanceBefore] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            override fun toString() =
                "InnerData{id=$id, accountId=$accountId, amount=$amount, balanceAfter=$balanceAfter, balanceBefore=$balanceBefore, createdAt=$createdAt, currency=$currency, status=$status, type=$type, description=$description, reference=$reference, additionalProperties=$additionalProperties}"
        }
    ...
    override fun toString() =
        "TransactionListResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
