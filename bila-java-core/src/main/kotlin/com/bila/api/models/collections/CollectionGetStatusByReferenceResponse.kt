...
class CollectionGetStatusByReferenceResponse
...
private constructor(
    ...
    /** A builder for [CollectionGetStatusByReferenceResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                collectionGetStatusByReferenceResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionGetStatusByReferenceResponse].
         *
         ...
         */
        fun build(): CollectionGetStatusByReferenceResponse =
            CollectionGetStatusByReferenceResponse(
     ...
     *   type.
     */
    fun validate(): CollectionGetStatusByReferenceResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionGetStatusByReferenceResponse &&
    ...
    override fun toString() =
        "CollectionGetStatusByReferenceResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
