...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransferListResponse].
         *
    ...
    /** A builder for [TransferListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transferListResponse: TransferListResponse) = apply {
            message = transferListResponse.message
            status = transferListResponse.status
            data = transferListResponse.data
            additionalProperties = transferListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferListResponse].
         *
         ...
         */
        fun build(): TransferListResponse =
     ...
     *   type.
     */
    fun validate(): TransferListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val data: JsonField<List<TransferResponseDto>>,
        ...
        private constructor(
            @JsonProperty("data")
            @ExcludeMissing
            data: JsonField<List<TransferResponseDto>> = JsonMissing.of(),
            @JsonProperty("meta")
            @ExcludeMissing
         ...
         */
        fun data(): List<TransferResponseDto> = data.getRequired("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<TransferResponseDto>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<TransferResponseDto>>? = null
            ...
            /** List of transfers */
            fun data(data: List<TransferResponseDto>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<TransferResponseDto>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun data(data: JsonField<List<TransferResponseDto>>) = apply {
                this.data = data.map { it.toMutableList() }
            }

            /**
             * Adds a single [TransferResponseDto] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: TransferResponseDto) = apply {
                this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferListResponse &&
    ...
    override fun toString() =
        "TransferListResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
