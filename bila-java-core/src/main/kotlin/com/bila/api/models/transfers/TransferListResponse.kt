    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * yet supported value.
                 */
                fun recipient(recipient: JsonField<Recipient>) = apply {
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.accountNumber] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
            ...
            override fun toString() =
                "InnerData{id=$id, amount=$amount, createdAt=$createdAt, currency=$currency, recipient=$recipient, reference=$reference, status=$status, type=$type, completedAt=$completedAt, narration=$narration, additionalProperties=$additionalProperties}"
        }
