...
private constructor(
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val data: JsonField<List<AccountResponseDto>>,
        ...
        private constructor(
            @JsonProperty("data")
            @ExcludeMissing
            data: JsonField<List<AccountResponseDto>> = JsonMissing.of(),
            @JsonProperty("meta")
            @ExcludeMissing
         ...
         */
        fun data(): List<AccountResponseDto> = data.getRequired("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<AccountResponseDto>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<AccountResponseDto>>? = null
            ...
            /** List of accounts */
            fun data(data: List<AccountResponseDto>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<AccountResponseDto>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun data(data: JsonField<List<AccountResponseDto>>) = apply {
                this.data = data.map { it.toMutableList() }
            }

            /**
             * Adds a single [AccountResponseDto] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: AccountResponseDto) = apply {
                this.data =
