...
class TransferRecipientCreateMobileMoneyParams
private constructor(
    ...
    /** A builder for [TransferRecipientCreateMobileMoneyParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = transferRecipientCreateMobileMoneyParams.body.toBuilder()
            additionalHeaders =
                transferRecipientCreateMobileMoneyParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                transferRecipientCreateMobileMoneyParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientCreateMobileMoneyParams].
         *
         ...
         */
        fun build(): TransferRecipientCreateMobileMoneyParams =
            TransferRecipientCreateMobileMoneyParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(country, operator, phone, accountName, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(country, operator, phone, accountName, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{country=$country, operator=$operator, phone=$phone, accountName=$accountName, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientCreateMobileMoneyParams &&
            body == other.body &&
    ...
    override fun toString() =
        "TransferRecipientCreateMobileMoneyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
