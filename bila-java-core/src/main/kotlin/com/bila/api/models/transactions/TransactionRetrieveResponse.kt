...
private constructor(
    ...
    private val data: JsonField<TransactionResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<TransactionResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<TransactionResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<TransactionResponseDto> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<TransactionResponseDto> = JsonMissing.of()
        ...
        fun data(data: TransactionResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [TransactionResponseDto] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<TransactionResponseDto>) = apply { this.data = data }
    ...
    override fun toString() =
        "TransactionRetrieveResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
