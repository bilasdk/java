...
class TransferRecipientCreateMobileMoneyResponse
...
private constructor(
    ...
    /** A builder for [TransferRecipientCreateMobileMoneyResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                transferRecipientCreateMobileMoneyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientCreateMobileMoneyResponse].
         *
         ...
         */
        fun build(): TransferRecipientCreateMobileMoneyResponse =
            TransferRecipientCreateMobileMoneyResponse(
     ...
     *   type.
     */
    fun validate(): TransferRecipientCreateMobileMoneyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientCreateMobileMoneyResponse &&
    ...
    override fun toString() =
        "TransferRecipientCreateMobileMoneyResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
