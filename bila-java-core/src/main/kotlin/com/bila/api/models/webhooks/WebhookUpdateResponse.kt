...
private constructor(
    ...
    private val data: JsonField<WebhookConfigResponseDto>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<WebhookConfigResponseDto> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<WebhookConfigResponseDto> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<WebhookConfigResponseDto> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<WebhookConfigResponseDto> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(webhookUpdateResponse: WebhookUpdateResponse) = apply {
            message = webhookUpdateResponse.message
            status = webhookUpdateResponse.status
        ...
        fun data(data: WebhookConfigResponseDto) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [WebhookConfigResponseDto] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<WebhookConfigResponseDto>) = apply { this.data = data }
    ...
    override fun toString() =
        "WebhookUpdateResponse{message=$message, status=$status, data=$data, additionalProperties=$additionalProperties}"
}
