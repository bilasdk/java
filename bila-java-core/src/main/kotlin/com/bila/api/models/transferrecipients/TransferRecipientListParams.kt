...
class TransferRecipientListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransferRecipientListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TransferRecipientListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TransferRecipientListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transferRecipientListParams: TransferRecipientListParams) = apply {
            page = transferRecipientListParams.page
            perPage = transferRecipientListParams.perPage
            type = transferRecipientListParams.type
            additionalHeaders = transferRecipientListParams.additionalHeaders.toBuilder()
            additionalQueryParams = transferRecipientListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransferRecipientListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransferRecipientListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferRecipientListParams &&
            page == other.page &&
    ...
    override fun hashCode(): Int =
        Objects.hash(page, perPage, type, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransferRecipientListParams{page=$page, perPage=$perPage, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
