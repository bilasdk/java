...
package com.usebila.api.core.http
...
import com.usebila.api.client.okhttp.OkHttpClient
import com.usebila.api.core.RequestOptions
import com.usebila.api.core.Sleeper
import com.usebila.api.errors.BilaRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw BilaRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            BilaRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
