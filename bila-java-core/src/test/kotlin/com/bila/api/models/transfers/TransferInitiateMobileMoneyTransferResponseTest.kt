    ...
    fun create() {
        val transferInitiateMobileMoneyTransferResponse =
            TransferInitiateMobileMoneyTransferResponse.builder()
                ...
                .status(true)
                .data(
                    TransferInitiateMobileMoneyTransferResponse.Data.builder()
                        .id("txn-001")
                        .amount(1000.0)
                        .createdAt(OffsetDateTime.parse("2024-01-15T10:30:00Z"))
                        .currency("ZMW")
                        .recipient(
                            TransferInitiateMobileMoneyTransferResponse.Data.Recipient.builder()
                        ...
                        .status(TransferInitiateMobileMoneyTransferResponse.Data.Status.SUCCESSFUL)
                        .type(TransferInitiateMobileMoneyTransferResponse.Data.Type.BANK_ACCOUNT)
