    ...
    fun create() {
        val collectionGetStatusByReferenceResponse =
            CollectionGetStatusByReferenceResponse.builder()
                ...
                .status(true)
                .data(
                    CollectionGetStatusByReferenceResponse.Data.builder()
                        .id("col-001")
                        .amount(100.0)
                        .createdAt(OffsetDateTime.parse("2024-01-15T10:30:00Z"))
                        .currency("ZMW")
                        .customer(
                            CollectionGetStatusByReferenceResponse.Data.Customer.builder()
                                .name("JOHN DOE")
                                .operator("airtel")
                                .phone("0977123456")
                                .build()
                        ...
                        .status(CollectionGetStatusByReferenceResponse.Data.Status.SUCCESSFUL)
                        .completedAt(OffsetDateTime.parse("2024-01-15T10:31:00Z"))
                        .feeBearer(CollectionGetStatusByReferenceResponse.Data.FeeBearer.MERCHANT)
