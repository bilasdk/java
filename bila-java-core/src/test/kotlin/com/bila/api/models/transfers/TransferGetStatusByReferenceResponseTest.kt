    ...
    fun create() {
        val transferGetStatusByReferenceResponse =
            TransferGetStatusByReferenceResponse.builder()
                ...
                .status(true)
                .data(
                    TransferGetStatusByReferenceResponse.Data.builder()
                        .id("txn-001")
                        .amount(1000.0)
                        .createdAt(OffsetDateTime.parse("2024-01-15T10:30:00Z"))
                        .currency("ZMW")
                        .recipient(
                            TransferGetStatusByReferenceResponse.Data.Recipient.builder()
                        ...
                        .status(TransferGetStatusByReferenceResponse.Data.Status.SUCCESSFUL)
                        .type(TransferGetStatusByReferenceResponse.Data.Type.BANK_ACCOUNT)
