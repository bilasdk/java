...
package com.usebila.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.usebila.api.client.BilaClientAsync
import com.usebila.api.client.BilaClientAsyncImpl
import com.usebila.api.core.ClientOptions
import com.usebila.api.core.LogLevel
import com.usebila.api.core.Sleeper
import com.usebila.api.core.Timeout
...
/**
 * A class that allows building an instance of [BilaClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class BilaOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BilaClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): BilaClientAsync = builder().fromEnv().build()
    }

    /** A builder for [BilaOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BilaClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BilaClientAsync =
            BilaClientAsyncImpl(
                clientOptions
                    .httpClient(
