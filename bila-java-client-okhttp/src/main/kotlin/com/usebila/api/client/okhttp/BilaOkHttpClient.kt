...
import com.usebila.api.client.BilaClientImpl
...
/**
 * A class that allows building an instance of [BilaClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class BilaOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BilaClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): BilaClient = builder().fromEnv().build()
    }

    /** A builder for [BilaOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BilaClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BilaClient =
            BilaClientImpl(
                clientOptions
                    .httpClient(
